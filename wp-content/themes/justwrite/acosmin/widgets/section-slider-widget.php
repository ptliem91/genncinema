...
if( ! class_exists( 'AC_Section_Slider' ) ) {
	class AC_Section_Slider extends AC_Section {
		...
		function widget( $args, $instance ) {
			...
			$section_delay		= ! empty( $instance['delay'] ) ? $instance['delay'] : 3000; set_query_var( 'section_delay', absint( $section_delay ) );
		...
		function form( $instance ){
			...
			?>
                ...
                <p>
                    ...
                    <input class="widefat" id="<?php echo $this->get_field_id( 'delay' ); ?>" name="<?php echo $this->get_field_name( 'delay' ); ?>" type="text" value="3000"/>
                </p>
                <p>
