 ...
 *
 *  You can find the widget in: /acosmin/widgets/section-categories-3col-widget.php
 * _____________________
 * 
...
<div class="col fourcol<?php if( $i == 3 ) { echo ' last';} ?>">
	...
	<div class="section-cat-wrap clearfix">
		...
		<?php
			...
			// The Query
			$query_posts = new WP_Query( apply_filters( 'ac_widget_cats_3col_query_filter', $query_args ) );
			$count = 0;
		...
		?>
			...
			<li class="sc-first-post clearfix sc-item">
				...
				<div class="sc-entry alignright">
					...
					<?php if( $scm ) { ?>
					<div class="sc-details">
						<a href="<?php comments_link(); ?>" class="comments-number" rel="nofollow"><?php comments_number( '0 comments', '1 comment', '% comments' ); ?></a>
					</div>
					<?php } ?>
				</div>
			</li>
